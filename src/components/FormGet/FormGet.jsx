              ...
              <div className="fr-modal__body">
                ...
                <div className="fr-modal__content">
                  ...
                  <form onSubmit={this.handleSubmitGet} id="form-get">
                    ...
                    <select  className="fr-select" value={this.state.application_statut} onChange={(e) => this.setState({ application_statut: e.target.value})}>
                    ...
                    <select className="fr-select" value={this.state.sensibilite} onChange={(e) => this.setState({ sensibilite: e.target.value})}>
                      <option value="S1" selected>S1</option>
                      <option value="S2">S2</option>
                      <option value="S3">S3</option>
                      <option value="S4">S4</option>
                    </select>
                    <select className="fr-select" value={this.state.ministere_responsable} onChange={(e) => this.setState({ ministere_responsable: e.target.value})}>
